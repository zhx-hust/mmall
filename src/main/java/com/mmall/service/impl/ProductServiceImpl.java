...
public class ProductServiceImpl implements IProductService {
    ...
    public ServerResponse<ProductDetailVo> getDetail(Integer productId) {
        ...
        if (product == null) {
            return ServerResponse.createByErrorMessage("商品已下架或被删除");
        }
        ProductDetailVo productDetailVo = formProductDetailVo(product);

        return ServerResponse.createBySuccess(productDetailVo);
    }

    private ProductDetailVo formProductDetailVo(Product product) {
...
//        private Integer parentCategoryId;
        ...
        if (category == null) {
            productDetailVo.setParentCategoryId(0);//无父类
        } else {
    ...
    public ServerResponse<PageInfo> getList(int pageNum, int pageSize) {
        ...
        for (Product productItem : productList) {
            ProductListVo productListVo = formProductListVo(productItem);
    ...
    private ProductListVo formProductListVo(Product productItem) {
...
//        private String imageHost;
    ...
    public ServerResponse<PageInfo> getProductByKeywordCategory(String keyword, Integer categoryId, Integer pageNum, Integer pageSize, String orderBy) {
        ...
        if (categoryId != null) {
            ...
            categoryIdList = iCategoryService.getAllGenerationsChildren(category.getId()).getData();
        }
